...
Public Class FrnNewGalaxyBoxPacking_Chennai
    ...
    Private Sub FrnNewGalaxyBoxPacking_Chennai_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        dtpMFDDate.Value = System.DateTime.Today

        Dim conString1 As String = ConfigurationSettings.AppSettings("conStrTEST").ToString()
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        For StI As Integer = StrPrQty To StrEnPrQty
            ...
            cmd = New SqlCommand(StrSqlSe1, conn)
    ...
    Private Sub txtstartqty_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtstartqty.KeyDown
        ...
        If (e.KeyCode = Keys.Enter) Then
            ...
            If getserialno <> "" Then
                ...
                cmd = New SqlCommand(StrSelInj, conn)
