...
Public Class injectorstock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APPASAMY_SOFT.injectorstock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinjectorstock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As injectorstock = New injectorstock
        rpt.Site = Me.Site
        Return rpt
    End Function
