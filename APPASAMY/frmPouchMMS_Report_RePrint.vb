...
Public Class frmPouchMMS_Report_RePrint
    ...
    Public Sub Form_Load()
        Try
            StrSql = " SELECT     Distinct PouchPack_to_Sterile_Move_NO " & _
                    " FROM         POUCH_LABEL  WHERE   PouchPack_to_Sterile_Move_status=1 order by  PouchPack_to_Sterile_Move_NO DESC "
            Ds = SQL_SelectQuery_Execute(StrSql)
            CmbMTSNo.Items.Clear()
            For Each eachRow1 As DataRow In Ds.Tables(0).Rows
                CmbMTSNo.Items.Add(eachRow1("PouchPack_to_Sterile_Move_NO"))
            Next
    ...
    Private Sub frmPouchMMS_Report_RePrint_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Form_Load()
    End Sub
        ...
        Try
            ...
            If CmbMTSNo.Text <> "" Then
                ...
                StrSql = " SELECT     distinct  Location_from, Location_To " & _
                        " FROM       PouchPack_to_Sterile_Move_details WHERE    Movement_No = '" & CmbMTSNo.Text & "'   "
                Ds = SQL_SelectQuery_Execute(StrSql)
                ...
                StrSql = " SELECT      Btc_No, Model_Name, Lot_Number,  Qty " & _
                        " FROM         PouchPack_to_Sterile_Move_details WHERE   Movement_No = '" & CmbMTSNo.Text & "'  " & _
