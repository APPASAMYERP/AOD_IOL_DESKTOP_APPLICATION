...
Public Class cryRackBinReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APPASAMY_SOFT.cryRackBinReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryRackBinReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryRackBinReport = New cryRackBinReport
        rpt.Site = Me.Site
        Return rpt
    End Function
