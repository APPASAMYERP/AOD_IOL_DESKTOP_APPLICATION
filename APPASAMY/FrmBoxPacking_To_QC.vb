...
Imports System.IO
Public Class FrmBoxPacking_To_QC
    ...
    Public Sub LoadMovementNO()
        ...
        Str_Header = 0
        Str_Detail = 0
        StrSqlSeHd = "Select Max(Header_ID) As Header, Max(Detail_ID) As Detail from Boxpack_to_QC "
    ...
    Public Sub Load_BPL_No()
        ...
        StrSql = "SELECT    DISTINCT   Btc_NO FROM    Qc_To_Boxpack   " & _
       " WHERE QC_To_boxpack='1' "
        ...
        StrSql = "SELECT  DISTINCT Btc_NO, qty from Qc_To_Boxpack  WHERE QC_To_boxpack='1' group by btc_no  "
    ...
    Public Function getBATCHNumbers() As String
        ...
        Dim btcs As String = ""
        Dim ds As New DataSet
        Dim StrSql As String = "SELECT DISTINCT Btc_No FROM Qc_To_Boxpack  " & _
        " WHERE QC_To_boxpack='1' group by btc_no    "
        Dim Cmd As New SqlCommand(StrSql, con)
        Dim ad As New SqlDataAdapter(Cmd)
        ad.Fill(ds)
    ...
    Private Sub btn_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Save.Click
        ...
        If DataGridView3.Rows.Count > 0 Then
            ...
            Else
                ...
                Sql = "Insert Into Boxpack_to_QC (  Header_ID, Detail_ID,  Movement_No, Btc_no,  Qty, Created_By, Created_Date, boxpack_To_QC) values" & strInsertQry
    ...
    Private Sub FrmBoxPacking_To_QC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
