...
Public Class CryTray_allot
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APPASAMY_SOFT.CryTray_allot.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryTray_allot
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryTray_allot = New CryTray_allot
        rpt.Site = Me.Site
        Return rpt
    End Function
