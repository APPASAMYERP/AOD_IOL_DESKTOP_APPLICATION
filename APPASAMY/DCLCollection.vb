...
Public Class DCLCollection
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APPASAMY_SOFT.DCLCollection.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDCLCollection
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DCLCollection = New DCLCollection
        rpt.Site = Me.Site
        Return rpt
    End Function
