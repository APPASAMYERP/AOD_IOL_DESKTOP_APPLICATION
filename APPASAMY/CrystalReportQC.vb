...
Public Class CrystalReportQC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APPASAMY_SOFT.CrystalReportQC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportQC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportQC = New CrystalReportQC
        rpt.Site = Me.Site
        Return rpt
    End Function
