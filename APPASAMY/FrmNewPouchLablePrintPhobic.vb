...
Public Class FrmNewPouchLablePrintPhobic
    ...
    End Sub
    Private Sub FrmNewPouchLablePrintPhobic_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If CmbShModel.Text = "AE-01" Then
            ...
            Else
                StrSno1 = StrStSrNo
            End If
        ElseIf CmbShModel.Text = "AE-INFO" Then
        ...
        'If (CmbShModel.Text = "502") Or (CmbShModel.Text = "601") Or (CmbShModel.Text = "701") Or (CmbShModel.Text = "nAs207") Or (CmbShModel.Text = "nAsY207") Or (CmbShModel.Text = "701H") Then

        '    StrFName = "PouchPhilic.btw"

        'ElseIf (CmbShModel.Text = "SPMFDY200" Or CmbShModel.Text = "SPMFD200" Or CmbShModel.Text = "SUPRAPHOB MS" Or CmbShModel.Text = "SP INFO") Then
        ...
        'ElseIf CmbShModel.Text = "AE-01" Then
        ...
        For StI As Integer = StrStPrQty To StrEnPrQty
            ...
            If (CmbShModel.Text = "SPMFDY200") Or (CmbShModel.Text = "SPMFD200") Or (CmbShModel.Text = "SUPRAPHOB MS") Or (CmbShModel.Text = "SP-TORIC T3" Or CmbShModel.Text = "SP-TORIC T4" Or CmbShModel.Text = "SP-TORIC T5" Or CmbShModel.Text = "SP-TORIC T6" Or CmbShModel.Text = "SP-TORIC T7" Or CmbShModel.Text = "SP-TORIC T8" Or CmbShModel.Text = "SP-TORIC T9" Or CmbShModel.Text = "MFD605" Or CmbShModel.Text = "MFDY605") Then
            ...
            If rdobrand.Checked = True Then
                strsql = " insert into POUCH_LABEL (Brand_Name,Model_Name,Reference_Name,GS_Code,Power,Optic,Length,Lot_Unit," & _
                         ...
                         "Sample_Taken,Type_Sample,BPL_Taken,Box_Packing,Dc_Packing,Created_By,Created_Date,Modified_By,Modified_Date,Sterilization_Reject,Qty_1,Type,Sterilization_After,Box_Reject,Print_Name,Btc_No,Cylsize,PouchStation,PouchBTWLabelName) values ( " & _
                         ...
                         "'" & strmfmonth & "','" & strmfyear & "','" & strexmonth & "','" & strexyear & "',0,0,'NO',0,0,0,'" & StrLoginUser & "',GETDATE(), '" & StrLoginUser & "',GETDATE(),0,1,'" & CmbType.Text & "',0,0,'" & CmbShBrand.Text & "','" & txtbtc.Text & "','" & txtcylsize.Text & "','" & station & "','" & cmbPrintLabel.Text & "' )"
            ...
            Else
                strsql = " insert into POUCH_LABEL (Brand_Name,Model_Name,Reference_Name,GS_Code,Power,Optic,Length,Lot_Unit," & _
                         ...
                         "'" & CmbShBrand.Text & "','" & CmbShModel.Text & "','" & LblShowRefName.Text & "','" & LblShowGSCode.Text & "','" & CmbShPower.Text & "','" & LblShowOptic.Text & "','" & LblShowLength.Text & "' ," & _
                         "'mm','" & LblshAConstant.Text & "','" & LblShowGSType.Text & "','" & txtquantity.Text & "','" & StrStPrQty & "','" & StrEnPrQty & "','" & LblShowLotPrefix.Text & "','" & LblShowLotNo.Text & "','" & StrlotBarNo & "' , " & _
                         "'" & strmfmonth & "','" & strmfyear & "','" & strexmonth & "','" & strexyear & "',0,0,'NO',0,0,0,'" & StrLoginUser & "',GETDATE(), '" & StrLoginUser & "',GETDATE(),0,1,'" & CmbType.Text & "',0,0,'" & LblShowRefName.Text & "','" & txtbtc.Text & "','" & txtcylsize.Text & "','" & station & "','" & cmbPrintLabel.Text & "' )"
            ...
            If Val(LblBalanceQty.Text) = 0 Then
                ...
                If CmbType.Text = "Export-Turkey" Then
                    ...
                    stringlotno = IntLot.ToString("000")
