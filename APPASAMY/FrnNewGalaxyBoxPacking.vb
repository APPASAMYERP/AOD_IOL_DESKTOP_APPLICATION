...
Public Class FrnNewGalaxyBoxPacking
    ...
    Private Sub FrnNewGalaxyBoxPacking_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub txtstartqty_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtstartqty.KeyDown
        ...
        If (e.KeyCode = Keys.Enter) Then
            ...
            If dtpMFDDate.Value.Month > 2 And dtpMFDDate.Value.Year >= 2023 Then
                MessageBox.Show("for current year lens, Use Box Packing form!!!", "Serial No Scan", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
            ...
            If getserialno <> "" Then
                ...
                ElseIf CmbShModel.Text = "601" Or CmbShModel.Text = "502" Or CmbShModel.Text = "701" Then
                    If rbExportNormal.Checked Or rbExport.Checked Then
                        StrFName = "ACRYFOLD_BT_EXPORT.btw"
                    Else
                        StrFName = "ACRYFOLD_BT_MAX _7.btw"
                    End If
                ...
                ElseIf CmbShBrand.Text = "SUPRAPHOB" And CmbShModel.Text = "SPNT300" Then
                    If rbExportNormal.Checked Or rbExport.Checked Then
                        StrFName = "SUPRA_PHOB_EXPORT.btw"
                    Else
                        StrFName = "SUPRA_PHOB.btw"
                    End If
                ...
                ElseIf CmbShModel.Text = "SPMFDY 200" Then

                    StrFName = "SUPRAPHOB_REGEN.btw"
                ...
                ElseIf CmbShModel.Text = "SP INFO" Then
                    If rbExportNormal.Checked Or rbExport.Checked Then
                        StrFName = "SUPRA_PHOB_INFO_EXPORT.btw"
                    Else
                        StrFName = "SUPRA_PHOB_INFO.btw"
                    End If
                ...
                ElseIf CmbShBrand.Text = "SUPRAPHOB TORIC" Then

                    StrFName = "SUPRA_PHOB_TORIC.btw"

                ElseIf CmbShBrand.Text = "LIBERTY RING" Then

                    StrFName = "LIBERTY_RING.btw"
