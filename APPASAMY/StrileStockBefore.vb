...
Public Class StrileStockBefore
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APPASAMY_SOFT.StrileStockBefore.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStrileStockBefore
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StrileStockBefore = New StrileStockBefore
        rpt.Site = Me.Site
        Return rpt
    End Function
