...
Public Class CrystalInjector
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APPASAMY_SOFT.CrystalInjector.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalInjector
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalInjector = New CrystalInjector
        rpt.Site = Me.Site
        Return rpt
    End Function
