...
Public Class DespatchReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APPASAMY_SOFT.DespatchReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDespatchReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DespatchReport = New DespatchReport
        rpt.Site = Me.Site
        Return rpt
    End Function
