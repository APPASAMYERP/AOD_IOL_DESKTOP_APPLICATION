...
Public Class Despatchbydate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APPASAMY_SOFT.Despatchbydate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDespatchbydate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Despatchbydate = New Despatchbydate
        rpt.Site = Me.Site
        Return rpt
    End Function
