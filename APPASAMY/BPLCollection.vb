...
Public Class BPLCollection
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APPASAMY_SOFT.BPLCollection.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBPLCollection
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BPLCollection = New BPLCollection
        rpt.Site = Me.Site
        Return rpt
    End Function
